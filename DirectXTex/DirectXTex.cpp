...
HRESULT LoadFromDDSFile(_In_z_ const wchar_t *szFile, _In_ DirectX::DDS_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept
{
	return DirectX::LoadFromDDSFile(szFile, flags, metadata, *image->image);
}
...
HRESULT LoadFromHDRFile(_In_z_ const wchar_t *szFile, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept
{
	return DirectX::LoadFromHDRFile(szFile, metadata, *image->image);
}
...
HRESULT LoadFromTGAFile(_In_z_ const wchar_t *szFile, _In_ DirectX::TGA_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept
{
	return DirectX::LoadFromTGAFile(szFile, flags, metadata, *image->image);
}
...
HRESULT LoadFromWICFile(_In_z_ const wchar_t *szFile, _In_ DirectX::WIC_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image, GetMQR getMQR)
{
	return DirectX::LoadFromWICFile(szFile, flags, metadata, *image->image, getMQR);
}
...
HRESULT LoadFromTGAFile2(_In_z_ const wchar_t *szFile, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept
{
	return DirectX::LoadFromTGAFile(szFile, metadata, *image->image);
}
