...
#pragma region ImageIO
	...
	API HRESULT LoadFromDDSFile(_In_z_ const DXTexWChar *szFile, _In_ DirectX::DDS_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	...
	API HRESULT SaveToDDSFile(_In_ const DirectX::Image &image, _In_ DirectX::DDS_FLAGS flags, _In_z_ const DXTexWChar *szFile) noexcept;
	API HRESULT SaveToDDSFile2(_In_reads_(nimages) const DirectX::Image *images, _In_ size_t nimages, _In_ const DirectX::TexMetadata &metadata, _In_ DirectX::DDS_FLAGS flags, _In_z_ const DXTexWChar *szFile) noexcept;
	...
	API HRESULT LoadFromHDRFile(_In_z_ const DXTexWChar *szFile, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;

	API HRESULT SaveToHDRMemory(_In_ const DirectX::Image &image, _Out_ BlobT *blob) noexcept;
	API HRESULT SaveToHDRFile(_In_ const DirectX::Image &image, _In_z_ const DXTexWChar *szFile) noexcept;
	...
	API HRESULT LoadFromTGAFile(_In_z_ const DXTexWChar *szFile, _In_ DirectX::TGA_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	...
	API HRESULT SaveToTGAFile(_In_ const DirectX::Image &image, _In_ DirectX::TGA_FLAGS flags, _In_z_ const DXTexWChar *szFile, _In_opt_ const DirectX::TexMetadata *metadata = nullptr) noexcept;

	API HRESULT LoadFromPNGFile(const DXTexWChar *szfile, DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	API HRESULT SaveToPNGFile(const DirectX::Image &image, const DXTexWChar *szfile) noexcept;

	API HRESULT LoadFromJPEGFile(const DXTexWChar *szfile, DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	API HRESULT SaveToJPEGFile(const DirectX::Image &image, const DXTexWChar *szfile) noexcept;

	API HRESULT LoadFromEXRFile(const DXTexWChar *szfile, DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	API HRESULT SaveToEXRFile(const DirectX::Image &image, const DXTexWChar *szfile) noexcept;
	...
	API HRESULT LoadFromWICFile(_In_z_ const DXTexWChar *szFile, _In_ DirectX::WIC_FLAGS flags, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image, GetMQR getMQR = nullptr);
	...
	API HRESULT SaveToWICFile(_In_ const DirectX::Image &image, _In_ DirectX::WIC_FLAGS flags, _In_ GUID guidContainerFormat, _In_z_ const DXTexWChar *szFile, _In_opt_ const GUID *targetFormat = nullptr, SetCustomProps customProps = nullptr);
	API HRESULT SaveToWICFile2(_In_count_(nimages) const DirectX::Image *images, _In_ size_t nimages, _In_ DirectX::WIC_FLAGS flags, _In_ GUID guidContainerFormat, _In_z_ const DXTexWChar *szFile, _In_opt_ const GUID *targetFormat = nullptr, SetCustomProps customProps = nullptr);
#endif // _WIN32
	...
	API HRESULT LoadFromTGAFile2(_In_z_ const DXTexWChar *szFile, _Out_opt_ DirectX::TexMetadata *metadata, ScratchImageT *image) noexcept;
	...
	API HRESULT SaveToTGAFile2(_In_ const DirectX::Image &image, _In_z_ const DXTexWChar *szFile, _In_opt_ const DirectX::TexMetadata *metadata = nullptr) noexcept;
