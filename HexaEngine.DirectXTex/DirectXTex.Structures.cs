...
namespace HexaEngine.DirectXTex
{
    ...
    public unsafe struct TexMetadata
    {
        ...
        {
            return (int)(MiscFlags2 & TexMiscFlags2.AlphaModeMask) == (int)TexAlphaMode.Premultiplied;
        }

        public void SetAlphaMode(TexAlphaMode mode)
        {
            MiscFlags2 = (MiscFlags2 & ~TexMiscFlags2.AlphaModeMask) | (TexMiscFlags2)mode;
        }

        public TexAlphaMode GetAlphaMode()
        {
            return (TexAlphaMode)(MiscFlags2 & TexMiscFlags2.AlphaModeMask);
        }
